...
class WebSocketManager:
    ...
    async def send_section_content(self, document_id: str, section_id: str, section_name: str, content_html: str):
        if document_id in self.active_connections:
            try:
...
def stream_to_websocket(document_id: str, section_id: str, section_name: str, content_html: str):
...
def wait_for_feedback_from_ws(section_id: str, timeout: int = 30) -> Optional[Dict]:
    ...
    try:
        ...
        if not document_ids:
            ...
            return {"feedback_type": "continue", "edited_content": None}
        ...
        print("No feedback received, using default continue feedback")
        return {"feedback_type": "continue", "edited_content": None}
